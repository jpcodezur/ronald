!function(exports, global) {
    global["true"] = exports, function() {
        PureChat = function(socketUrl, userId, domainId, authToken, identifyStatus, errorStatus, restrictTransports, poppedOut, emailMD5Hash) {
            ...
            registerHandler("opInvite"), registerHandler("roomchanged"), registerHandler("roomclosed"), 
            registerHandler("rooms"), registerHandler("onlineOperatorStatus"), registerHandler("opStatus"), 
            registerHandler("serverNotice"), this.socket.on("connect", function() {
                t.setConnectionStatus(1), t.identify(t.currentUserId, t.currentDomainId, t.currentAuthToken, identifyStatus, t.poppedOut, t.emailMD5Hash);
            ...
            function identifiedCallback(success) {
    ...
    var Marionette = function(global, Backbone, _) {
        ...
        return Marionette.extend = Backbone.Model.extend, Marionette.getOption = function(target, optionName) {
            ...
            render: function(template, data) {
                ...
                var templateFunc;
                return (templateFunc = "function" == typeof template ? template : Marionette.TemplateCache.get(template))(data);
            }
    ...
    purechatApp.module("Constants", function(Constants) {
        ...
        window.onerror = function(errorMsg, url, lineNumber, column, exceptionObj) {
            "undefined" != typeof window.pcDashboard && Logging.logger && Logging.logger.log("ERROR", errorMsg + " [line:" + lineNumber + "] " + url, exceptionObj.stack);
        };
        var LoggingController = Marionette.Controller.extend({
            initialize: function() {},
            log: function(level, message, stackTrace) {
                ...
                if (logLevel.isGreaterOrEqual(level)) try {
                    $.ajax({
                        ...
                        data: {
                            ...
                            message: message,
                            stackTrace: escape(stackTrace.substr(0, 75))
                        },
                        timeout: 2e4,
                        success: function() {},
                        error: function() {}
        ...
        $.throttle = function(delay, no_trailing, callback, debounce_mode) {
            ...
            return message ? (message = message.replace(/&amp;/g, "&"), linkifiedMessage = message.replace(/(www\.)?(?=[a-zA-Z0-9])(([-a-zA-Z0-9@:%_\+~#?&//=]){2,256}\.){1,}(co|fr|in|biz|xxx|mobi|me|com|my|ru|me|net|edu|gov|io|us|org|info|tv|mobi|au|nz|uk|br|es|dk|se|fi|nl|ca|sg|eu|py|it|mx)\b([?/][-a-zA-Z0-9@:%_\+.~#?&//=]*)?/gi, function(url) {
            ...
            "function" != typeof Date.prototype.toHourMinuteString && (Date.prototype.toHourMinuteString = function() {
                ...
                return (hours % 12 == 0 ? 1 : hours % 12) + ":" + (10 > minutes ? "0" + minutes : minutes) + ":" + (10 > seconds ? "0" + seconds : seconds) + amPM;
            });
        ...
        this.templates = this.templates || {}, this.templates.ChatConnecting = function(o) {
            ...
            return __p += '<p class="greeting" data-resourcekey="greeting">' + (null == (__t = o.getResource("greeting", {
            ...
            var __p = "";
            return _.escape, Array.prototype.join, __p += '<div class="purechat-message-display-container"><div class="purechat-message-display purechat-clearfix"></div></div><div class="purechat-send-form-container"><form class="purechat-send-form" action=""><textarea class="purechat-send-form-message" name="purechat-send-form-message" /><div class="disableTextArea" style=""/>', 
            ...
            if (_.escape, Array.prototype.join, "note" == o.type) __p += '<p class="purechat-message-note important" data-username="' + (null == (__t = o.username) ? "" : __t) + '" data-resourcekey="' + (null == (__t = o.resourceKey || "") ? "" : __t) + '">' + (null == (__t = o.message) ? "" : __t) + "</p>"; else if ("message" == o.type && o.message) {
                ...
                message = purechatApp.Utils.linkify(message), __p += '<div data-resourcekey="' + (null == (__t = o.resourceKey || "") ? "" : __t) + '" class="purechat-message-container ' + (null == (__t = o.myMessage ? "purechat-message-right" : "purechat-message-left") ? "" : __t) + '"><img class="gravitar operator-gravatar ' + (null == (__t = o.myMessage ? "right" : "left") ? "" : __t) + '" height="50" width="50" src="' + (null == (__t = o.avatarUrl) ? "" : __t) + '" alt="Operator avatar" /><div class="purechat-message"><span class="purechat-displayname">' + (null == (__t = o.userName) ? "" : __t) + '</span><span class="name-message-separator">:</span> <span>' + (null == (__t = message) ? "" : __t) + '</span> <span class="message-time-separator">-</span> <span class="time">' + (null == (__t = o.time) ? "" : __t) + '</span></div><div class="timestamp"><span class="time">' + (null == (__t = o.time) ? "" : __t) + "</span></div></div>";
            }
            return __p;
            ...
            __p += '<div class="' + (null == (__t = o.get("isPersonalChat") ? "purechat-personal-widget-content-wrapper" : "purechat-widget-content-wrapper") ? "" : __t) + '"><div class="purechat-widget-header">', 
            ...
            __p += '<div class="purechat-widget-title">', isPersonalChat ? mobile && (__p += '<a class="purechat-show-personal-details" href="#"><i class="fa fa-chevron-left"></i></a>') : (__p += '<img src="' + (null == (__t = o.absoluteUrl("/Content/images/widget-logo-32.png")) ? "" : __t) + '" class="purechat-title-image-out-of-way small" alt="" /><img src="' + (null == (__t = o.absoluteUrl("/Content/images/widget-logo-64.png")) ? "" : __t) + '" class="purechat-title-image-out-of-way large" alt="" />', 
            ...
            isPersonalChat ? mobile && (__p += '<a class="purechat-show-personal-details" href="#"><i class="fa fa-chevron-left"></i></a>') : (__p += '<img src="' + (null == (__t = o.absoluteUrl("/Content/images/widget-logo-32.png")) ? "" : __t) + '" class="purechat-title-image-out-of-way small" alt="" /><img src="' + (null == (__t = o.absoluteUrl("/Content/images/widget-logo-64.png")) ? "" : __t) + '" class="purechat-title-image-out-of-way large" alt="" />', 
        ...
        Views.WidgetLayout = Marionette.Layout.extend({
            ...
            setTitle: function(title, resourceKey) {
                ...
                this.ui.collapsedTitle.data("isTitleEditor", !0), window.pcPersonalEditor.execute("editButton:show", [ this.ui.title, this.ui.collapsedTitle ]));
            },
            ...
            executeCommand: function(e) {
                if (e.preventDefault(), !this.settings.get("isInEditorMode")) {
            ...
            onRender: function() {
                ...
                this.settings.get("isDemo") || "true" != localStorage.expanded || this.settings.get("ForcePopout") || this.settings.get("usePrototypeFallback") || !inRoomOnLoad && this.settings.get("StartChatImmediately") ? this.onCollapse(!0) : this.expand(!0, inRoomOnLoad), 
            ...
            onSuperMinimize: function(args, e, doTimeout) {
                ...
                var self = this, minFnc = function() {
                    ...
                    self.$el.css(self.$el.hasClass("purechat-bottom-right") || self.$el.hasClass("purechat-bottom-left") ? {
                        bottom: baseAmount
                    } : {
                        top: baseAmount
            ...
            unpeekWidget: function() {
                var self = this;
                !self.settings.get("RequestFromMobileDevice") && self.$el.hasClass("purechat-widget-super-collapsed") && self.$el.css(self.$el.hasClass("purechat-bottom-right") || self.$el.hasClass("purechat-bottom-left") ? {
            ...
            expand: function(firstLoad, inRoomOnLoad) {
                var self = this;
                ...
                var completeFnc = function() {
                    var defFnc = function() {
                        ...
                        self.ui.widgetCollapsed.hide(), self.ui.widgetExpanded.show();
                    };
                    inRoomOnLoad || "PCStateChatting" == self.model.get("state") || "PCStateClosed" == self.model.get("state") || !self.settings.get("StartChatImmediately") || self.settings.get("isInEditorMode") ? defFnc() : Marionette.getOption(self, "chatAutoStarted") || (self.chatAutoStarted = !0, 
                    app.request("startChatAutomatically").done(defFnc).fail(function() {})), self.model.set("expanded", !0), 
            ...
            typing: function(userId, userDisplayName, isTyping) {
                ...
                }) + '<div data-username="' + userDisplayName + '" data-resourcekey="chat_typing" class="purechat-typing">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>'), 
                this.options.settings.get("isPersonalChat") && this.options.settings.get("isInEditorMode") && window.pcPersonalEditor.execute("editButton:show", statusDiv.find("[data-resourcekey]"))) : statusDiv.remove();
            },
            appendBuffer: function(compositeView, buffer) {
                var $container = this.getItemViewContainer(compositeView);
                $container.append(buffer);
            ...
            hideFixedTooltip: function(e) {
                ...
                tooltip && (tooltip.close(), sender.data("activetooltip", null));
            },
            initialize: function() {
    ...
    PCWidgetState = Marionette.Controller.extend({
        ...
        States.PCStateInactive = PCWidgetState.extend({
            ...
            app.reqres.setHandler("startChatAutomatically", function() {
                return inactiveInstance.startChatAutomatically();
            });
        }), States.addFinalizer(function() {
            app.reqres.removeHandler("startChatAutomatically");
        });
        ...
        States.PCStateChatting = PCWidgetState.extend({
            ...
            onEnter: function() {
                ...
                self.getDataController().connectToChatServer(this).done(function() {
                    try {
                        ...
                        }), self.getWidgetView().content.show(self.messageView), self.getWidgetView().$el.find(".purechat-start-chat-button-container button").html('Back to Chat<i style="margin-left: .5em;" class="fa fa-chevron-right"></i>'), 
                        self.getWidgetView().onShow(), self.getWidgetView().focusInput(), self.getDataController().sendRoomHistory(), 
            ...
            onMessage: function(userId, userDisplayName, roomId, roomDisplayName, time, message, isHistory, timeElapsed, protocolVersion, senderAvatarUrl, fromOperator) {
        ...
        States.PCStateClosed = PCWidgetState.extend({
            ...
            handleRoomClose: function(response, room) {
                ...
                self.getDataController().connectionInfo.clearLocalStorage(), self.getWidgetView().setTitle(self.getResource("title_chatClosed"), "title_chatClosed");
                var m = new backbone.Model({
                ...
                m.set(self.chatModel.get("isOperator") ? {
                    GoogId: "",
                    GaTrackingTab: !1,
                    GaTrackingChat: !1,
                    GaTrackingThumbs: !1,
            ...
            onEnter: function() {
                ...
                self.personalDetails.triggerMethod("afterInserted")), self.chatModel.get("isOperator") ? isNaN(parseInt(room.id)) ? self.handleRoomClose.call(self, null, room) : $.ajax({
                    type: "get",
                    dataType: "json",
            ...
            onRestartChat: function() {
                ...
                self.getDataController().restartChat().done(function() {
                    ...
                    self.getDataController().connectionInfo.clearLocalStorage(), self.getChatModel().set("state", app.Constants.WidgetStates.Inactive);
                    var widgetLayout = self.getWidgetView();
                    self.options.get("StartChatImmediately") && (self.getChatModel().set("state", app.Constants.WidgetStates.Initializing), 
                    widgetLayout.$el.find(".purechat-widget-content").css("visibility", "hidden"), widgetLayout.$el.find(".purechat-widget-content").parent().find("div:last").css("visibility", "hidden"), 
                    app.request("startChatAutomatically").done(function() {
                        widgetLayout.$el.find(".purechat-widget-content").css("visibility", "visible"), 
                        widgetLayout.$el.find(".purechat-widget-content").parent().find("div:last").css("visibility", "visible");
                    }));
                }).fail(function() {
                    alert("fail");
                });
        ...
        var BaseDataController = Marionette.Controller.extend({
            ...
            getWidgetSettings: function() {
                ...
                d.resolve(window.parent.currentWidgetSettings)) : this.options.isPersonalChat && window.pcPersonalEditorSettings ? (window.pcPersonalEditorSettings.set({
            ...
            bindEvents: function(handler) {
                ...
                var eventHandlers = {
                    message: function(userId, userDisplayName, roomId, roomDisplayName, time, message) {
    ...
    purechatApp.module("Controllers", function(Controllers, app, Backbone, Marionette, $) {
        ...
        var PureChatController = Marionette.Controller.extend({
            ...
            initialize: function(options) {
                ...
                options.get("isPersonalChat") && options.get("isInEditorMode") && (window.pcDemoChatModel = chatModel)), 
            ...
            onRendered: function() {
                if (this.widgetLayout.setCannedResponses(this.options.get("cannedResponses")), this.widgetLayout.setTitle(this.options.get("isInvisible") ? this.options.get("room").name + " (Eavesdropping)" : this.options.get("room").name), 
