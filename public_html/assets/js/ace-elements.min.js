...
function actualizoPaginas(){
        act = false;
        $("ul.wizard-steps li").each(function(i){
            $(this).hide();
            
            if((act !== false && (/*i >= act &&*/ i<=(act+4)))){
                $(this).show();
                $(this).css("max-width","20%");
                $(this).css("min-width","20%");
            }
...
(function(e, c) {
    ...
    f.prototype.show_file_list = function(k) {
        ...
        this.$label.attr("data-title","Hola");
